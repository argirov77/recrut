  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4 text-primary dark:text-white">About Us</h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 mb-8">
        <h2 className="text-2xl font-semibold mb-6 text-primary dark:text-white">Tech Stack</h2>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
        <h2 className="text-2xl font-semibold mb-6 text-primary dark:text-white">Project Goals</h2>
